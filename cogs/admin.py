...
class Admin(commands.Cog):
    ...
    #
    #     if user == None:
    #         errorEmbed = utils.embed(title="Invalid User", description="Please specify an valid user.",
    #                                    color=discord.Color.red())
    #         await ctx.send(embed=errorEmbed)
    #         return
    #
    #     successEmbed = utils.embed(title="Seller Added", description=f"Seller <@{user.id}> has been added.",
    ...
    #
    #
    #     successEmbed = utils.embed(title="Top Sellers", description=f"Top Sellers Sorted By Rate:\n{sellerslist}",
    #                                  color=discord.Color.green())
    #     await ctx.send(embed=successEmbed)
    #
    ...
    #     embed = utils.embed(title="Rate Help", description="Rate commands are for keeping track of how much sellers have sold.")
    ...
    #         amount = int(amount)
    #     except:
    #         errorEmbed = utils.embed(title="Invalid Amount", description="Please specify an valid amount.",
    #                                    color=discord.Color.red())
    #         await ctx.send(embed=errorEmbed)
    #         return
    #
    ...
    #         json.dump(data, f, indent=4)
    #
    #     successEmbed = utils.embed(title="Rate Increased", description=f"Seller <@{user.id}>'s rate has been increased by `{amount}M`, and is now `{rate}M`.",
    #                                  color=discord.Color.green())
    #     await ctx.send(embed=successEmbed)
    #
    # @rate.command()
    ...
    #         amount = int(amount)
    #     except:
    #         errorEmbed = utils.embed(title="Invalid User", description="Please specify an valid amount.",
    #                                    color=discord.Color.red())
    #         await ctx.send(embed=errorEmbed)
    #         return
    #
    ...
    #         json.dump(data, f, indent=4)
    #
    #     successEmbed = utils.embed(title="Rate Decreased",
    ...
    #         json.dump(data, f, indent=4)
    #
    #     successEmbed = utils.embed(title="Rate Set",
    ...
    #         json.dump(data, f, indent=4)
    #
    #     successEmbed = utils.embed(title="Rate Increased",
    #                                  description=f"Seller <@{user.id}>'s rate is currently `{rate}M`.",
    #                                  color=discord.Color.green())
    #     await ctx.send(embed=successEmbed)

    async def channel_autocomplete(self, ctx: discord.AutocompleteContext):
        channels = []
