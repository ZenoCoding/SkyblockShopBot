...
class Stock(commands.Cog):
    ...
    async def stock(self, ctx):
        ...
        stockEmbed.set_footer(icon_url=ctx.guild.icon_url, text=f"Quick and easy deliver provided by {ctx.guild.name}.")
    ...
    async def set(self, ctx, amount="default"):
        ...
        errorEmbed.set_footer(icon_url=ctx.guild.icon_url, text=f"Quick and easy deliver provided by {ctx.guild.name}.")
    ...
    async def broadcast(self, ctx, channel="default"):
        ...
        if channel == "default" or channel == None:
            ...
            successEmbed.set_footer(icon_url=ctx.guild.icon_url, text=f"Quick and easy deliver provided by {ctx.guild.name}.")
